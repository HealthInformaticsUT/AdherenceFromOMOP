...
plot(cma_values$CMA1, show.legend = TRUE, legend.bkg.opacity = 1, print.CMA  = FALSE, plot.CMA = F, align.all.patients = FALSE, align.first.event.at.zero = TRUE, period.in.days = 60)

# 2:  (60+90) / 210
# 1: (30+90+180) / 300
```
![FIGURE 1 - Example of CMA1 graph, visualised with AdhereR](./figs/fig_cma1.png)
...
# 30 + 90 + 180 + 180 / 336
```
![FIGURE 2 - Example of CMA2 graph, visualised with AdhereR](./figs/fig_cma2.png)
...
-   Computes: **(number of days covered between first and last event) / (days between first and last event)**
...
# 1 - (90) / 300 or 210 / 300
```
![FIGURE 3 - Example of CMA5 graph, visualised with AdhereR](./figs/fig_cma5.png)
...
-   Events that start before observation window are not included
-   Computes: **(number of days covered between first event and end of observation window) / (days between first event and observation window)**
...
```
![FIGURE 4 - Example of CMA6 graph, visualised with AdhereR](./figs/fig_cma6.png)
...
-   Computes: **(number of days covered in observation window) / (number of days in observation window)**
...
![FIGURE 5 - Example of CMA7 graph, visualised with AdhereR](./figs/fig_cma7.png)
...
-   Computes: **(number of days covered between first event and end of observation window) / (lagged start to end of observation window)**
...
```
![FIGURE 6 - Example of CMA8 graph, visualised with AdhereR](./figs/fig_cma8.png)
...
```
![FIGURE 7 - Example of CMA9 graph, visualised with AdhereR](./figs/fig_cma9.png)
